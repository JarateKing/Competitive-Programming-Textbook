...
\textbf{Adjacency lists} are a graph representation in which we have an array of each node, where each node stores its edges. This can either be as an array of \mintinline{cpp}{Node} objects, or as an array of edge lists. We can take some shortcuts in our implementation:

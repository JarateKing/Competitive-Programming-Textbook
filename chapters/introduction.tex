...
\index {Recreational Programming}
...
\index{Programming Contests}

There are a handful of prominent contests that regularly get held:

\begin{itemize}
\item ICPC \index{ICPC} (International Collegiate Programming Contest) is the main programming contest for university students.
\item IOI \index{IOI} (International Olympiad in Informatics) is the main programming contest for highschool students.
\end{itemize}

\subsection{Programming Sites}
\index{Programming Sites}
...
\begin{itemize}
\item Kattis \index{Kattis}
\item Codeforces \index{Codeforces}
\item Atcoder \index{Atcoder}
\item Codechef \index{Codechef}
\item UVa \index{UVa}
\end{itemize}
